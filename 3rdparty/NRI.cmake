...
file(REMOVE_RECURSE "${NRI_VMA_OVERLAY_ROOT}")
file(MAKE_DIRECTORY "${NRI_VMA_OVERLAY_ROOT}/include")

# Latest NRI can be consumed directly, but it still expects a VMA source root containing include/vk_mem_alloc.h.
configure_file(
...
add_subdirectory("${NRI_SOURCE_ROOT}" "${CMAKE_CURRENT_BINARY_DIR}/NRI")
