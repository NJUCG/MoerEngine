...
public:
    ...
    TextureRef Process(
        ...
        if (editor_ui->IsSeperateWindow() && editor_ui->GetWindowFrameBuffer().GetTexture()) {
            ...
            cmd_list.Gfx(sample_texture_pipeline, input_color_texture, Sampler(SF_LINEAR, SAM_CLAMP_TO_EDGE))
                .Draw(
                    "SampleTexture",
