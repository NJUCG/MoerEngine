...
TextureRef RTResource::GetDefaultEnvMap() { return GetTexture(default_env_map_name); }
...
BufferRef RTResource::GetBuffer(std::string_view _name) const { return nullptr; }
