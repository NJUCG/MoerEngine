...
int main(int argc, char** argv) {
    ...
    constexpr std::array kCases = {
        ...
        ShaderCompileCase{"RGDispatchBindless.Vulkan", "tests/RGDispatchBindless.comp.hlsl", "main", ST_COMPUTE, SP_VULKAN_SM6},
        ShaderCompileCase{"RayQueryMinimal.Vulkan", "tests/RayQueryMinimal.comp.hlsl", "main", ST_COMPUTE, SP_VULKAN_SM6},
        ShaderCompileCase{"RGRayQueryHit.Vulkan", "tests/RGRayQueryHit.comp.hlsl", "main", ST_COMPUTE, SP_VULKAN_SM6},
        ShaderCompileCase{"RGRaySceneBindless.Vulkan", "tests/RGRaySceneBindless.comp.hlsl", "main", ST_COMPUTE, SP_VULKAN_SM6},
