...
namespace Moer::Render {
    ...
    ToneMappingPass::ToneMappingPass(
        ...
        Scene&         _scene,
        CreateInfo     _info) : device(_device),
                            manager(_manager),
        ...
        tone_mapping_constants2 = device.CreateBuffer<Moer::byte>(sizeof(ToneMappingParams), EBufferUsageFlags::CONSTANT_BUFFER);
    ...
    void ToneMappingPass::Render(
        ...
        _cmd_list.Gfx(tone_mapping_pass_pipeline, tone_mapping_constants, _src_tex, exposure_buffer, color_lut, linear_clamp_sampler)
            .Draw("ToneMapping",
