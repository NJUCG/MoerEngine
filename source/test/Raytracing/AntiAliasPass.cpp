...
namespace Moer::Render {
    ...
    AntialiasPass::AntialiasPass(RenderDevice& _device, ShaderManager& _manager, Scene& _scene, CreateInfo _info)
        : manager(_manager),
          scene(_scene),
    ...
    void AntialiasPass::Process(CommandList& _cmd_list, RTContext& _rt_ctx, Params _param, bool _prev_view_valid, TextureRef _input, TextureRef _output) {
        TAAParams params{};
        ...
        _cmd_list.Compute(taa_pipeline,
                          constant_buffer,
                          _input,
                          motion,
                          feedback_color_ping,
        ...
        switch (jitter_mode) {
            ...
            case EJitter::MSAA: {
                const float2 offsets[] = {
                    float2(0.0625f, -0.1875f), float2(-0.0625f, 0.1875f), float2(0.3125f, 0.0625f), float2(-0.1875f, -0.3125f), float2(-0.3125f, 0.3125f), float2(-0.4375f, 0.0625f), float2(0.1875f, 0.4375f), float2(0.4375f, -0.4375f)};
