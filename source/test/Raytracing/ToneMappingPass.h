...
namespace Moer::Render {
    ...
    public:
        ToneMappingPass(class RenderDevice& _device, class ShaderManager& _manager, Scene& _scene, CreateInfo _info);
        void Process(class CommandList& _cmd_list, RTContext& _rt_ctx, Params _params, TextureRef _src_tex, TextureRef _target);
    ...
    private:
        ...
        void                 Render(CommandList& _cmd_list, RTContext& _rt_ctx, Params _params, TextureRef _src_tex, TextureRef _target);
