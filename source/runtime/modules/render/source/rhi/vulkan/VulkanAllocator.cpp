...
namespace Moer::Render {
    ...
    VulkanAllocator::ScratchAllocator::ScratchAllocator(VulkanDevice* _device, VkTmpBufferAllocator* _allocator) : VulkanDeviceObject(_device), allocator(_allocator) {
