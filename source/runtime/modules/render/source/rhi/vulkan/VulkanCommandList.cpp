...
namespace Moer::Render {
    ...
    void ResolveTextureBarrierInfo(VkImageMemoryBarrier2& _barrier, ETextureStateFlags _state, EPassType _pass) {
        ...
        transfer_state_any_or(TS_COLOR_ATTACHMENT, VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT, uint32_t(ERHIPipelineStageFlags::PS_COLOR_ATTACHMENT_OUTPUT), VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);

        transfer_state_any_or(TS_RESOLVE_ATTACHMENT, VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT, uint32_t(ERHIPipelineStageFlags::PS_COLOR_ATTACHMENT_OUTPUT), VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);
