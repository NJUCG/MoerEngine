...
namespace Moer {
    ...
    private:
        ...
        RHIShaderResourceViewRef meshlet_descs_buffer_view;
        RHIShaderResourceViewRef meshlet_bounds_buffer_view;

        RHIUnorderedAccessViewRef draw_indirect_view;
        RHIUnorderedAccessViewRef draw_count_view;
    };
