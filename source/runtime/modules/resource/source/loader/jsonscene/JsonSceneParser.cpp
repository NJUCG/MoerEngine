...
namespace Moer::Resource::JsonScene {
    ...
    public:
        ...
        ExtendedSceneData() : scn_dat(UniquePtr<SceneData>(MoerNew(SceneData))), vertex_cnt(0), index_cnt(0), meshlet_cnt(0) {}
    ...
    RESOURCE_API UniquePtr<SceneData> Moer::Resource::JsonScene::JsonSceneParser::LoadSceneFromFile(const Path& abs_scn_json_path) noexcept {
        Impl impl;
    ...
    bool Moer::Resource::JsonScene::JsonSceneParser::Impl::LoadEntityMeshData(ExtendedSceneData& dst, const Json& entity_json) {
        try {
    ...
    void Moer::Resource::JsonScene::JsonSceneParser::Impl::ProcessMesh(ExtendedSceneData& dst, const aiScene* mesh_scene) {
    ...
    Transform Moer::Resource::JsonScene::GetTransform(const Json& json) {
        ...
        Quaternion q = EulerYZXToQuaternion(AI_DEG_TO_RAD(rotation.x), AI_DEG_TO_RAD(rotation.y), AI_DEG_TO_RAD(rotation.z));
