...
// RENDER_API UniquePtr<SceneData>
// Moer::JsonScene::JsonSceneParser::LoadSceneFromFile(const Path& abs_scn_json_path) noexcept {
//     Impl impl;
...
// bool Moer::JsonScene::JsonSceneParser::Impl::LoadEntityMeshData(
//     ExtendedSceneData& dst,
...
// void Moer::JsonScene::JsonSceneParser::Impl::ProcessMesh(
//     ExtendedSceneData& dst,
...
// void Moer::JsonScene::JsonSceneParser::Impl::LoadCube(ExtendedSceneData& dst) {
//     Assimp::Importer importer;
//     importer.SetPropertyInteger(AI_CONFIG_PP_SBP_REMOVE, aiPrimitiveType_LINE | aiPrimitiveType_POINT);
//     // clang-format off
