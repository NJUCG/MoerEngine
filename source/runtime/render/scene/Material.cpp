...
MaterialBuilder&
MaterialBuilder::SetTexture(const std::string& name, ETextureDimension textureType) noexcept {
...
MaterialBuilder&
MaterialBuilder::SetParameter(const std::string& name, UniformType type, uint32_t size) noexcept {
