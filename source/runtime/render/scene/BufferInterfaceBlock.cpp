...
BufferInterfaceBlock::Builder::add(std::initializer_list<InterfaceBlockEntry> list) {
...
BufferInterfaceBlock::Builder&
BufferInterfaceBlock::Builder::addVariableSizedArray(InterfaceBlockEntry const& item) {
...
BufferInterfaceBlock::BufferInterfaceBlock(Builder const& builder) noexcept :
    m_name(builder.mName),
    m_field_info_list(builder.mEntries.size()) {
