...
#define INNER_GET_STRUCTURE_METADATA_IMPL(StructureName, ParameterUsage)                       \
    {                                                                                          \
        static ShaderParametersMetadata s_struct_metadata(                                     \
            ParameterUsage, #StructureName, sizeof(StructureName), StructureName::GetMembers() \
        );                                                                                     \
        return &s_struct_metadata;                                                             \
    }

#define BEGIN_ROOT_PARAMETER_DEFINITION(StructureName)                                                     \
    INNER_BEGIN_SHADER_PARAMETER_DEFINITION(                                                               \
        StructureName,                                                                                     \
        INNER_GET_STRUCTURE_METADATA_IMPL(StructureName, EShaderParameterUseCase::SHADER_ROOT_PARAMETERS), \
        TRUE                                                                                               \
    )
...
#define BEGIN_SHADER_CONSTANT_STRUCT_DEFINITION(StructureName)                                             \
    INNER_BEGIN_SHADER_PARAMETER_DEFINITION(                                                               \
        StructureName,                                                                                     \
        INNER_GET_STRUCTURE_METADATA_IMPL(StructureName, EShaderParameterUseCase::SHADER_CONSTANT_STRUCT), \
    )
...
#define INNER_BEGIN_SHADER_PARAMETER_DEFINITION(StructureName, GetStructMetadataFunctionImpl, ...)          \
    ...
    public:                                                                                                 \
        StructureName() {                                                                                   \
            memset(this, 0, sizeof(StructureName));                                                         \
        }                                                                                                   \
        /* struct type info*/                                                                               \
        struct TypeInfo {                                                                                   \
    ...
    private:                                                                                                \
        ...
        static void* AppendMemberGetPrev(_firstMemberId, Moer::Array<ShaderParametersMetadata::Member>*) {  \
            return nullptr;                                                                                 \
        }                                                                                                   \
        typedef _firstMemberId

#define INTERNAL_DEFINE_SHADER_PARAM_IMPL(                                                             \
    MemberTypeInfo, MemberType, MemberName, HlslType, Precision, UBMTBaseType, MemberScope, PublicDefs \
)                                                                                                      \
    MemberId##MemberName;                                                                              \
...
public:                                                                                                \
    PublicDefs                                                                                         \
        ...
        enum {                                                                                         \
            HasDeclaredResource = MemberId##MemberName::HasDeclaredResource                            \
        };                                                                                             \
    };                                                                                                 \
    static void* AppendMemberGetPrev(                                                                  \
        _nextMemberId##MemberName, Moer::Array<ShaderParametersMetadata::Member>* _members             \
    ) {                                                                                                \
                                                                                                       \
...
#define DEFINE_SHADER_PARAM_CBV(HLSLType, MemberName) \
    INTERNAL_DEFINE_SHADER_PARAM_IMPL(                \
        TShaderResourceParameterTypeInfo<RHICBV*>,    \
        RHICBV*,                                      \
        MemberName,                                   \
        HLSLType,                                     \
...
#define DEFINE_SHADER_PARAM_UAV(HLSLType, MemberName) \
    INTERNAL_DEFINE_SHADER_PARAM_IMPL(                \
        TShaderResourceParameterTypeInfo<RHIUAV*>,    \
        RHIUAV*,                                      \
        MemberName,                                   \
        HLSLType,                                     \
        EShaderPrecisionModifier::FLOAT,              \
...
#define DEFINE_SHADER_PARAM_UAV_ARRAY(HLSLType, MemberName, NumElements) \
    INTERNAL_DEFINE_SHADER_PARAM_IMPL(                                   \
        TShaderResourceParameterTypeInfo<RHIUAV* [NumElements]>,         \
        RHIUAV*,                                                         \
        MemberName,                                                      \
        HLSLType,                                                        \
        EShaderPrecisionModifier::FLOAT,                                 \
...
#define DEFINE_SHADER_PARAM_SRV(HLSLType, MemberName) \
    INTERNAL_DEFINE_SHADER_PARAM_IMPL(                \
        TShaderResourceParameterTypeInfo<RHISRV*>,    \
        RHISRV*,                                      \
        MemberName,                                   \
        HLSLType,                                     \
        EShaderPrecisionModifier::FLOAT,              \
...
#define DEFINE_SHADER_PARAM_SRV_ARRAY(HLSLType, MemberName, NumElements) \
    INTERNAL_DEFINE_SHADER_PARAM_IMPL(                                   \
        TShaderResourceParameterTypeInfo<RHISRV* [NumElements]>,         \
        RHISRV*,                                                         \
        MemberName,                                                      \
        HLSLType,                                                        \
        EShaderPrecisionModifier::FLOAT,                                 \
...
#define DEFINE_SHADER_PARAM_SAMPLER(HLSLType, MemberName) \
    INTERNAL_DEFINE_SHADER_PARAM_IMPL(                    \
        TShaderResourceParameterTypeInfo<RHISampler*>,    \
        RHISampler*,                                      \
        MemberName,                                       \
        HLSLType,                                         \
        EShaderPrecisionModifier::FLOAT,                  \
...
#define DEFINE_SHADER_PARAM_SAMPLER_ARRAY(HLSLType, MemberName, NumElements) \
    INTERNAL_DEFINE_SHADER_PARAM_IMPL(                                       \
        TShaderResourceParameterTypeInfo<RHISampler* [NumElements]>,         \
        RHISampler*,                                                         \
        MemberName,                                                          \
        HLSLType,                                                            \
        EShaderPrecisionModifier::FLOAT,                                     \
...
#define DEFINE_SHADER_PARAM_STRUCT(StructType, MemberName) \
    INTERNAL_DEFINE_SHADER_PARAM_IMPL(                     \
        TShaderParameterStructureTypeInfo<StructType>,     \
        StructType,                                        \
        MemberName,                                        \
        StructType,                                        \
        EShaderPrecisionModifier::FLOAT,                   \
