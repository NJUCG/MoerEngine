...
private:
    ...
    Moer::UnorderedMap<WindowType*, Moer::Array<WindowContext::OnCursorEnterFunc>>
                                                                                 window_on_cursor_enter_func;
    ...
    Moer::UnorderedMap<WindowType*, Moer::Array<WindowContext::OnFrameBufferSizeFunc>>
                                                                           window_on_frame_buffer_size_func;
    Moer::UnorderedMap<WindowType*, Moer::Array<WindowContext::OnKeyFunc>> window_on_key_func;
    Moer::UnorderedMap<WindowType*, Moer::Array<WindowContext::OnMouseButtonFunc>>
                                                                              window_on_mouse_button_func;
    Moer::UnorderedMap<WindowType*, Moer::Array<WindowContext::OnScrollFunc>> window_on_scroll_func;
    Moer::UnorderedMap<WindowType*, Moer::Array<WindowContext::OnWindowCloseFunc>>
        window_on_window_close_func;
    Moer::UnorderedMap<WindowType*, Moer::Array<WindowContext::OnWindowContentScaleFunc>>
        window_on_window_content_scale_func;
    ...
    Moer::UnorderedMap<WindowType*, Moer::Array<WindowContext::OnWindowFocusFunc>>
        window_on_window_focus_func;
};
} // namespace Moer
#endif
