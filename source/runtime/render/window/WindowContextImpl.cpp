...
void WindowImpl::RegisterOnFrameBufferSizeFunc(
    WindowType*                          handle,
    WindowContext::OnFrameBufferSizeFunc func
) {
...
void WindowImpl::RegisterOnWindowContentScaleFunc(
    WindowType*                             handle,
    WindowContext::OnWindowContentScaleFunc func
) {
