...
void VkNRDPlugin::CollectRetiredInterfaces() {
...
UniquePtr<NRDInterface> VkNRDPlugin::RecreateInterface(
    ...
    return MakeUnique<VkNRDPluginInterface>(m_device, max_frame_in_flight, _frame_width, _frame_height);
}
...
public:
    VkNrdPluginDenoiseCmd(
        VkNRDPluginInterface&     _nrd,
...
void VkNRDPluginInterface::Denoise(
    ...
    _cmd_list.AddCustomCommand(
        MakeUnique<VkNrdPluginDenoiseCmd>(
            *this,
            _denoiser,
