...
struct FRDGTextureSubresource {
    FRDGTextureSubresource() : MipIndex(0), PlaneSlice(0), ArraySlice(0) {}
    ...
    inline bool operator==(const FRDGTextureSubresource& RHS) const {
        return MipIndex == RHS.MipIndex && PlaneSlice == RHS.PlaneSlice && ArraySlice == RHS.ArraySlice;
    }
...
struct FRDGTextureSubresourceLayout {
    FRDGTextureSubresourceLayout() : NumMips(0), NumPlaneSlices(0), NumArraySlices(0) {}
    ...
    FRDGTextureSubresourceLayout(const TextureInfo& Desc) :
        FRDGTextureSubresourceLayout(
            Desc.NumMips,
            Desc.ArraySize * (Desc.IsTextureCube() ? 6 : 1),
            IsStencilFormat(Desc.Format) ? 2 : 1
        ) {}
    ...
    inline uint32 GetSubresourceIndex(FRDGTextureSubresource Subresource) const {
        assert(Subresource < GetMaxSubresource());
        return Subresource.MipIndex + (Subresource.ArraySlice * NumMips) +
               (Subresource.PlaneSlice * NumMips * NumArraySlices);
    }
    ...
    inline bool operator==(FRDGTextureSubresourceLayout const& RHS) const {
        return NumMips == RHS.NumMips && NumPlaneSlices == RHS.NumPlaneSlices &&
    ...
    uint32 NumArraySlices : 16; //for depth
};
...
struct FRDGTextureSubresourceRange {
    ...
    bool operator==(FRDGTextureSubresourceRange const& RHS) const {
        return MipIndex == RHS.MipIndex && PlaneSlice == RHS.PlaneSlice && ArraySlice == RHS.ArraySlice &&
               NumMips == RHS.NumMips && NumPlaneSlices == RHS.NumPlaneSlices &&
               NumArraySlices == RHS.NumArraySlices;
    }
    ...
    FRDGTextureSubresource GetMaxSubresource() const {
        return FRDGTextureSubresource(
            MipIndex + NumMips, ArraySlice + NumArraySlices, PlaneSlice + NumPlaneSlices
        );
    }
    ...
    void EnumerateSubresources(TFunction Function) const {
        ...
        for (uint32 LocalPlaneSlice = MinSubresource.PlaneSlice; LocalPlaneSlice < MaxSubresource.PlaneSlice;
             ++LocalPlaneSlice) {
            for (uint32 LocalArraySlice = MinSubresource.ArraySlice;
                 LocalArraySlice < MaxSubresource.ArraySlice;
                 ++LocalArraySlice) {
                for (uint32 LocalMipIndex = MinSubresource.MipIndex; LocalMipIndex < MaxSubresource.MipIndex;
                     ++LocalMipIndex) {
    ...
    bool IsWholeResource(const FRDGTextureSubresourceLayout& Layout) const {
        return MipIndex == 0 && PlaneSlice == 0 && ArraySlice == 0 && NumMips == Layout.NumMips &&
               NumPlaneSlices == Layout.NumPlaneSlices && NumArraySlices == Layout.NumArraySlices;
    }

    bool IsValid(const FRDGTextureSubresourceLayout& Layout) const {
        return MipIndex + NumMips <= Layout.NumMips && PlaneSlice + NumPlaneSlices <= Layout.NumPlaneSlices &&
...
inline void VerifyLayout(
    const TRDGTextureSubresourceArray<ElementType, AllocatorType>& SubresourceArray,
    const FRDGTextureSubresourceLayout&                            Layout
) {
    assert(Layout.GetSubresourceCount() > 0 && "Subresource layout has no subresources.");
    assert(
        SubresourceArray.size() == Layout.GetSubresourceCount() &&
        "Subresource array does not match the subresource layout."
    );
}

template<typename ElementType, typename AllocatorType>
inline void InitTextureSubresources(
    ...
    SubresourceArray.resize(SubresourceCount);
...
template<typename ElementType, typename AllocatorType>
inline const ElementType& GetSubresource(
    const TRDGTextureSubresourceArray<ElementType, AllocatorType>& SubresourceArray,
    const FRDGTextureSubresourceLayout&                            Layout,
    FRDGTextureSubresource                                         Subresource
) {
...
template<typename ElementType, typename AllocatorType>
inline ElementType& GetSubresource(
    TRDGTextureSubresourceArray<ElementType, AllocatorType>& SubresourceArray,
    const FRDGTextureSubresourceLayout&                      Layout,
    FRDGTextureSubresource                                   Subresource
) {
...
inline void EnumerateSubresourceRange(
    TRDGTextureSubresourceArray<ElementType, AllocatorType>& SubresourceArray,
    const FRDGTextureSubresourceLayout&                      Layout,
