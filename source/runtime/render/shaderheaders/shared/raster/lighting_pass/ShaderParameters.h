...
static constexpr uint RASTER_PROBE_STREAMING_PREFETCHED = 1u << 19u;
static constexpr uint RASTER_PROBE_CLIPMAP_REUSED = 1u << 20u;
...
static const uint RASTER_PROBE_STREAMING_PREFETCHED = 1u << 19u;
static const uint RASTER_PROBE_CLIPMAP_REUSED = 1u << 20u;
