...
* Below is an example of how to use the Sponza scene.
  ...
  3. Let `scene_path=./asset/scenes/sponza/Sponza.gltf` in `./source/configs/MoerEngine.toml`.
    * If you don't have `MoerEngine.toml` in that directory, you need to copy `MoerEngine.toml` to `template.MoerEngine.ini` and modify it.
  4. Run MoerEngine.
